...
<div class="container">
    <div class="jumbotron">
        ...
        <div class="comments">
            ...
            <a style="color: white;" href="profiles.php?user=<?=$user_name?>"><img alt="user avatar" src="<?php if($avatar == NULL){ echo "Pictures/empty-user.jpg"; }else{ echo "Pictures/".$avatar;}?>" width="100" height="100"></a>
            <p><?=$comment?></p>
        </div>
        <?php } ?>
    </div>
