                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Captcha</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="checkbox" name="terms" id="terms" style="padding-top: 7px"> <label for="terms">I agree on the <a href="terms.html">terms and conditions</a></label>
                                <button id="agree" type="submit" name="submit" class="btn btn-default" value="send" style="padding-top: 10px">Sign up</button>
                                <?php
                                echo $newrecord;
                                ?>
                                <script>
