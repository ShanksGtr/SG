        ...
        <div>
            <form class="form-horizontal" action="register.php" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" pattern=".{4,32}" name="username" class="form-control" id="inputUsername" placeholder="Username" oninvalid="setCustomValidity('Must be between 4 to 30 characters ')">
                    </div>
                </div>
                <div class="form-group">
