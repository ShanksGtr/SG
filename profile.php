        ...
        <div class="container">
            <div class="jumbotron">
                <div class="page-header">
                    ...
                    <?php if ($_SESSION['username'] == true) { ?>
                        <a class="btn btn-default btn-lg" style="float: right; margin-top: -83px;margin-right: -20px;font-family: 'Press Start 2P', cursive;" href="profiledit.php" type="submit">Edit</a>
                    <?php } else {
                    }?>
                </div>
