                        ...
                        <div class="col col-md-3">
                            <div>
                                <div>
                                    ...
                                    <img alt="user avatar" class="img-circle" style="height: 200px; width: 240px; margin-left: -10px" src="<?php if($avatar == NULL){ echo "Pictures/empty-user.jpg"; }else{ echo "Pictures/".$avatar;} ?>"><br> Dimensions: 200x200 <br> maxsize: 1mb <br> Files: jpg, jpeg and png
                                    <form id="uploadfile" action="Pictures/avataring.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <span class="btn btn-primary btn-file"><input type="file" name="fileToUpload" id="fileToUpload" accept="image/*">Browse...</span>
